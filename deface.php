...
";
system(" play-audio 'code.mp3' ");
$a= readline("your code name : ");
system(" play-audio 'titl6.mp3' ");
$d= readline("\033[1;35m your title : ");

system(" play-audio 'team.mp3' ");
